...
Feature: Add badges to the system
  ...
  Scenario: Setting badges settings
    ...
    Then the field with xpath "//input[@name='issuercontact']" matches value "testuser@example.com"
    And the field with xpath "//input[@name='issuername']" matches value "Test Badge Site"
